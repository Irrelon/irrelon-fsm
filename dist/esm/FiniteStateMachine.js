export class FiniteStateMachine {
     ...
     */
    initialState = async (stateName, ...rest) => {
     ...
     */
    enterState = async (newStateName, ...rest) => {
        ...
        this._transitionQueue.push(async () => {
            ...
            const result = await this._transitions[this._currentStateName][newStateName](...rest);
            if (result instanceof Error) {
     ...
     */
    raiseEvent = async (eventName, ...rest) => {
